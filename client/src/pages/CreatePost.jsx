...
export const CreatePost = () => {
    ...
    const DALLE_URL = 'http://localhost:8080/api/v1/dalle/generate'
    ...
    const handleSurpriseMe = () => {
        ...
        setForm({ ...form, prompt: randomEntry })
    }
    ...
    const generateImage = async () => {
        if (form.prompt) {
            ...
            alert("PLEASE DON'T FORGET TO ENTER A PROMPT :)")
        }
    }
        ...
        <form className='mt-16 max-w-3x1' onSubmit={handleSubmit}>
            <div className='flex flex-col gap-5'>
                ...
                <FormField
                    ...
                    type="text"
                    name="prompt"
                    placeholder="Robot amarillo sentado sobre un mural del che guevara, estilo animacion pixar"
                    value={form.prompt}
                    handleChange={handleChange}
                    isSurpriseMe
            ...
            <div className="mt-10">
                <p className="mt-2 text-[#666e75] text-[14px]">** Una vez que ya creaste lo que querías, compartilo con la comunidad! **</p>
                <button
                    type="submit"
                    className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                >
                    {loading ? 'Compartiendo...' : 'Compartilo con la comunidad'}
                </button>
            </div>                 
        </form>
    </section>
